//==========================================================================
// retnet_recurrent.cpp
//==========================================================================
// @brief: A retnet kernel for LLM

#include "retnet_recurrent.h"
#include "layer.h"
#include "model.h"
#include <fstream>
#include <iomanip>
...
void dut(hls::stream<bit32_t> &strm_in, hls::stream<bit32_t> &strm_out) {
  ...
  // call retnet_recurrent
  output = retnet_recurrent_xcel(input);
...
//----------------------------------------------------------
// retnet_recurrent Accelerator
//----------------------------------------------------------
// @param[in] : input - the testing instance
// @return : the predicted digit

bit32_t retnet_recurrent_xcel(ubit8_t input[D_e]) {
  bit16_t output[D_e];
